...
const SEED_DATA = [
  ...
  { id: '5', tanggal: '10-Jan', keterangan: 'Biaya Cloud Dedicated Server untuk Web Sekolah, LMS, SIAKAD, PPDB dan Bank Soal Bulan Januari 2026', debit: 0, kredit: 6315901 },
  ...
  { id: '9', tanggal: '15-Jan', keterangan: 'Pembelian standing brosur untuk Lab 2 dan buku besar untuk catatan di pos satpam', debit: 0, kredit: 87000 },
  { id: '10', tanggal: '15-Jan', keterangan: 'Pembayaran biaya pengiriman dokumen PKWT Satpam ke PT. Trengginas Jaya', debit: 0, kredit: 20000 },
  ...
  { id: '13', tanggal: '22-Jan', keterangan: 'Pembelian tisu dan rak kamar mandi kepala sekolah', debit: 0, kredit: 205800 },
  ...
  { id: '18', tanggal: '27-Jan', keterangan: 'Pembelian tempat sampah untuk kamar mandi kepala sekolah', debit: 0, kredit: 20000 },
  { id: '19', tanggal: '28-Jan', keterangan: 'Pembayaran upah perawatan gorong gorong (Pak Yudi)', debit: 0, kredit: 500000 },
  ...
  { id: '23', tanggal: '6-Feb', keterangan: 'Pembelian 3D Printer Filament untuk keperluan praktikum', debit: 0, kredit: 137000 },
  ...
  { id: '27', tanggal: '18-Feb', keterangan: 'Pembayaran bahan dan upah perbaikan kabel aula', debit: 0, kredit: 537325 },
  { id: '28', tanggal: '23-Feb', keterangan: 'Upah dan perbaikan panel listrik pos satpam', debit: 0, kredit: 710000 },
  { id: '29', tanggal: '23-Feb', keterangan: 'Pembelian paket data 2 orbit untuk kebutuhan Expo Expose', debit: 0, kredit: 47000 },
  { id: '30', tanggal: '26-Feb', keterangan: 'Pembelian bahan dan upah perbaikan kunci', debit: 0, kredit: 120000 },
  { id: '31', tanggal: '27-Feb', keterangan: 'Pembayaran bahan dan upah perbaikan bocoran lab', debit: 0, kredit: 1350326 },
  { id: '32', tanggal: '27-Feb', keterangan: 'Pembayaran upah perawatan gorong gorong (Pak Yudi)', debit: 0, kredit: 500000 },
  { id: '33', tanggal: '27-Feb', keterangan: 'Pembelian pakan ikan dan bensin', debit: 0, kredit: 125000 },
  { id: '34', tanggal: '2-Mar', keterangan: 'Pembelian 3D Printer Filament untuk keperluan praktikum', debit: 0, kredit: 216400 },
  ...
  { id: '37', tanggal: '6-Mar', keterangan: 'Biaya Cloud Dedicated Server untuk Web Sekolah Bulan Maret 2026', debit: 0, kredit: 6318401 },
  { id: '38', tanggal: '9-Mar', keterangan: 'Pengembalian uang daftar wa business', debit: 123210, kredit: 0 },
  { id: '39', tanggal: '10-Mar', keterangan: 'Pembelian kabel ties ukuran besar 4,8 * 300 mm', debit: 0, kredit: 47515 },
  { id: '40', tanggal: '11-Mar', keterangan: 'Pembayaran biaya pengiriman dokumen', debit: 0, kredit: 21000 },
  { id: '41', tanggal: '12-Mar', keterangan: 'Pembayaran biaya pengiriman dokumen ke Direktorat SMK', debit: 0, kredit: 17000 },
  { id: '42', tanggal: '13-Mar', keterangan: 'Pembelian bahan dan upah pekerjaan perbaikan pintu sarpra', debit: 0, kredit: 1347000 },
  { id: '43', tanggal: '13-Mar', keterangan: 'Pembayaran upah perbaikan lantai depan TU', debit: 0, kredit: 50000 },
];

async function seedData() {
  console.log(`Starting to seed ${SEED_DATA.length} records to Kas_TU...`);
  ...
  for (let i = 0; i < SEED_DATA.length; i++) {
    ...
    try {
      ...
      console.error(`[${i + 1}/${SEED_DATA.length}] Error inserting:`, err);
    }
  }
